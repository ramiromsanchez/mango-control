...
public class GCalDataSourceRT extends PollingDataSource {
    ...
    public void setPointValue(DataPointRT dataPoint, PointValueTime valueTime, SetPointSource source) {
        ...
        GCalPointLocatorVO locatorVO = ((GCalPointLocatorRT) dataPoint.getPointLocator()).getVO();
    ...
    private MangoValue getValue(GCalPointLocatorVO locatorVO, ResultSet rs, String fieldName, long time)
